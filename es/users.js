    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", axios.get("/api/v2/users", {
              headers: {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", axios.get("/api/v2/users/".concat(userID), {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            })["catch"](function (error) {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", axios.patch("/api/v2/users/me", updateParams, {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            })["catch"](function (error) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", axios.put("/api/v2/users/me/tags", {
              headers: {
                Authorization: "Bearer ".concat(token)
              },
              data: updatedTags
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt("return", axios.put("/api/v2/users/me/photo", {
              headers: {
                Authorization: "Bearer ".concat(token),
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _context6.abrupt("return", axios.get("/pic/thumb/".concat(unixID, ".jpg"), {
              headers: {
                Authorization: "Bearer ".concat(token)
              },
              responseType: "blob"
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return _context7.abrupt("return", axios.get("/pic/large/".concat(unixID, ".jpg"), {
              headers: {
                Authorization: "Bearer ".concat(token)
              },
              responseType: "blob"
